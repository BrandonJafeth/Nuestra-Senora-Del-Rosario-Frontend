...
import { useThemeDark } from '../../hooks/useThemeDark'; // Hook for dark mode
        ...
        <table className="min-w-full bg-white dark:bg-[#0D313F] border border-gray-300 dark:border-gray-600 rounded-lg shadow-md">
          <thead>
            <tr className="bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-white">
              ...
              <th className="py-2 px-4 border dark:border-gray-500">Product Name</th>
              <th className="py-2 px-4 border dark:border-gray-500">Quantity</th>
              <th className="py-2 px-4 border dark:border-gray-500">Date</th>
              <th className="py-2 px-4 border dark:border-gray-500">Category</th>
              <th className="py-2 px-4 border dark:border-gray-500">Unit of Measure</th>
            </tr>
          </thead>
          <tbody>
            {[...Array(5)].map((_, index) => (
