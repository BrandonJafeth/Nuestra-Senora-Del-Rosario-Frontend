...
const HomeConfig = () => {
  ...
  return (
    ...
    >
      <h1 className="text-4xl font-bold mb-6">¡Bienvenido al sistema de configuracion!</h1>
      <p className="text-lg mb-6 max-w-2xl text-center">
        ...
        Explora las diferentes secciones desde el menú lateral para gestionar el sistema de configuración de forma eficiente y sencilla.
      </p>
      <img
